...
CFG_PATH = os.environ.get("YOLO_CFG_PATH", os.path.join(MODEL_DIR, "yolov3.cfg"))
WEIGHTS_PATH = os.environ.get("YOLO_WEIGHTS_PATH", os.path.join(MODEL_DIR, "yolov3_custom_final.weights"))
